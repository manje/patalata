...
Copiado de https://github.com/friendica/friendica/blob/develop/src/Util/JsonLD.php 
con pequeñísimas adaptaciones
...
class JsonLD
{
	...
	{
		$basepath=app_path('../resources/jsonld');
		switch ($url) {
			case 'https://w3id.org/security/v1':
				$url = $basepath . '/static/security-v1.jsonld';
				break;
			case 'https://w3id.org/security/data-integrity/v1':
				$url = $basepath . '/static/security-data-integrity-v1.jsonld';
				break;
			case 'https://w3id.org/security/multikey/v1':
				$url = $basepath . '/static/security-multikey-v1.jsonld';
				break;
			case 'https://w3id.org/identity/v1':
				$url = $basepath . '/static/identity-v1.jsonld';
				break;
			case 'https://www.w3.org/ns/activitystreams':
				$url = $basepath . '/static/activitystreams.jsonld';
				break;
			case 'https://www.w3.org/ns/did/v1':
				$url = $basepath . '/static/did-v1.jsonld';
				break;
			case 'https://funkwhale.audio/ns':
				$url = $basepath . '/static/funkwhale.audio.jsonld';
				break;
			case 'http://schema.org':
				$url = $basepath . '/static/schema.jsonld';
				break;
			case 'http://joinmastodon.org/ns':
				$url = $basepath . '/static/joinmastodon.jsonld';
				break;
			case 'https://purl.archive.org/socialweb/webfinger':
				$url = $basepath . '/static/socialweb-webfinger.jsonld';
				break;
			default:
				switch (parse_url($url, PHP_URL_PATH)) {
					case '/schemas/litepub-0.1.jsonld':
						$url = $basepath . '/static/litepub-0.1.jsonld';
						break;
					case '/apschema/v1.2':
					case '/apschema/v1.9':
					case '/apschema/v1.10':
						$url = $basepath . '/static/apschema.jsonld';
						break;
					default:
	...
	{
                require_once ('jsonld.php');
		\jsonld_set_document_loader('JsonLD::documentLoader');
